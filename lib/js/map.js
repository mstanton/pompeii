...
var Pompeii = function (pompeii) {
    ...
    pompeii.init = function () {
        ...
        for (key in pompeii.coords) {
            $('#jump_' + key).on('click', function () {
                ...
                $('.jumpmarker_container li a').css('color', '#fff');
                $(this).css('color', '#cfb348');
                return false;
            });
        }
    ...
    pompeii.bindTweets = function () {
        ...
        $('#tweets > li').mouseleave(function(){
            $(this).removeClass('modal_link');
        });

        $('#tweets > li').click(function(){
            var tweetnumber = $(this).attr('data');

            if ( tweetnumber == 'tweet_2' || tweetnumber == 'tweet_3' || tweetnumber == 'tweet_4' || tweetnumber == 'tweet_6' || tweetnumber == 'tweet_9' || tweetnumber == 'tweet_16' || tweetnumber == 'tweet_19' || tweetnumber == 'tweet_22' || tweetnumber == 'tweet_25' || tweetnumber == 'tweet_26' ) {    
