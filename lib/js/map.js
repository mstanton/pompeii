...
var Pompeii = function (pompeii) {
    ...
    pompeii.coords['theatre'] = new google.maps.LatLng(40.748809, 14.488440999999966); // test location
    pompeii.coords['tunnel'] = new google.maps.LatLng(40.748843, 14.488707999999974);  // test location
    pompeii.coords['riot'] = new google.maps.LatLng(40.75084, 14.495337000000063); // riot ampitheatre location
    ...
    pompeii.coords['nocera'] = new google.maps.LatLng(40.74.8906, 14.49443199999996); // Porta Nocera
    pompeii.coords['venus'] = new google.maps.LatLng(40.751544,   14.493321000000037); // The House Venus in a Shell
    pompeii.coords['ampitheatre'] = new google.maps.LatLng(); // Ampitheatre
    ...
    pompeii.coords['vesu'] = new google.maps.LatLng(); // Mount Vesuvius temple of Jupiter shot
    pompeii.coords['misenum'] = new google.maps.LatLng(40.818661, 14.071423999999979); // Misenum
    pompeii.coords['pompeiiOne'] = new google.maps.LatLng(); // Pompeii
    pompeii.coords['pompeiiTwo'] = new google.maps.LatLng(); // Pompeii
    ...
    pompeii.init = function () {
        ...
        pompeii.coords['theatre'].marker = new google.maps.Marker({
            position: pompeii.coords['theatre'],
            map: map,
            icon: new google.maps.MarkerImage('assets/marker/coin.png'),
            title: 'Ampitheatre',
            id: 'theatre'
        });
        pompeii.coords['riot'].marker = new google.maps.Marker({
            position: pompeii.coords['riot'],
            map: map,
            icon: new google.maps.MarkerImage('assets/marker/coin.png'),
            title: 'Riot Ampitheatre',
            id: 'riot'
        });
        pompeii.coords['tunnel'].marker = new google.maps.Marker({
            position: pompeii.coords['tunnel'],
            map: map,
            icon: new google.maps.MarkerImage('assets/marker/coin.png'),
            title: 'Tunnel',
            id: 'tunnel'
