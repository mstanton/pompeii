...
var Pompeii = function (pompeii) {
    ...
    pompeii.coords['sittingman'] = new google.maps.LatLng(40.749052, 14.486837000000037); // sitting man hidden in the garden ;) 
    ...
    pompeii.coords['sittingman'].artifact = {
        name: 'Sitting Man',
        location: '40.749052, 14.486837000000037',
        panos: ["QXEDDujJ-hR4QRkFU1jlgw", "FGt7LV1gcze_lpEFFRwRRg", "hWeWorZStaiND53GBdO5fg", "67kBrryUSIHhy_gDrjNNZQ", "QXEDDujJ-hR4QRkFU1jlgw"],
    ...
    pompeii.coords['castfemale'].artifact = {
        ...
        img: 'assets/artifacts/thumb_castfemail.png',
        coin: 'assets/marker/marker_small.png',
        loaded: false
    }
